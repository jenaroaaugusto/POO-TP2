...
public class ClienteVisao extends javax.swing.JPanel implements Visao{
    ...
    TabelaCliente modelo = new TabelaCliente(Database.getInstance().getClientes());
    ClienteControle controle = (ClienteControle) Fabrica.getFabrica("cliente").criaControle();
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        controle.removerCliente(modelo.getValueAt(Table.convertRowIndexToModel(Table.getSelectedRow())));
    ...
    private void editConfirmButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editConfirmButtonActionPerformed
        controle.editarCliente(modelo.getValueAt(Table.getSelectedRow()), editNomeField.getText());
        modelo.fireTableDataChanged();
        editDialog.dispose();
        setEnabled(true);
